...
{
    return make_bounded_relation_page( lua, ids, maximum, [kind]( const auto & id ) {
...
{
    return make_bounded_relation_page( lua, ids, maximum, []( const auto & id ) -> decltype( auto ) {
        return id.str();
    } );
}
...
{
    return make_bounded_relation_page( lua, values,
