...
void mortar_examine_actor::call( Character &you, const tripoint_bub_ms &examp ) const
{
    ...
    cata::lua_ui::dispatch_native_hook( "on_mortar_fired", {
        { "character", static_cast<const Character *>( &you ) },
        {
            "source", cata::lua_ui::native_callback_point {
        ...
        {
            "furniture", cata::lua_ui::native_callback_id {
                "furniture", here.furn( examp ).id().str()
            }
        },
        {
            "ammunition", cata::lua_ui::native_callback_id {
                "item", ammunition_id
            }
        }
    } );
