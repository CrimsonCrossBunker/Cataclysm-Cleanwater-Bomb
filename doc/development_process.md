...
>
> Stable document ID / 稳定文档 ID: `archive-upstream-development-process`
> 中文: https://crimsoncrossbunker.github.io/CCB-Docs/archive/governance/development-process/
> English: https://crimsoncrossbunker.github.io/CCB-Docs/en/archive/governance/development-process/
> Moved date / 迁移日期: `2026-08-02`
> Last in-repository commit / 仓库内最后适用 commit: `0378ca2b84303cf614c617c9d9eaa50138cd21ff`
> Obsolete upstream governance names, roles, and process conflict with current CCB policy.
