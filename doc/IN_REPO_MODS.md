...
> [!IMPORTANT] **Moved / 已迁移**
>
> Stable document ID / 稳定文档 ID: `mods.in-repository-policy`
> 中文: https://crimsoncrossbunker.github.io/CCB-Docs/mods/in-repository-policy/
> English: https://crimsoncrossbunker.github.io/CCB-Docs/en/mods/in-repository-policy/
