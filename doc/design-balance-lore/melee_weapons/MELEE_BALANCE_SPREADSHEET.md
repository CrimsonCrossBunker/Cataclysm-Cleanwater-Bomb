...
>
> Stable document ID / 稳定文档 ID: `archive-melee-balance-spreadsheet`
> 中文: https://crimsoncrossbunker.github.io/CCB-Docs/archive/design/melee-balance-spreadsheet/
> English: https://crimsoncrossbunker.github.io/CCB-Docs/en/archive/design/melee-balance-spreadsheet/
> Moved date / 迁移日期: `2026-08-02`
> Last in-repository commit / 仓库内最后适用 commit: `0378ca2b84303cf614c617c9d9eaa50138cd21ff`
> The source page self-identifies as substantially out of date and has no current CCB validation trail.
