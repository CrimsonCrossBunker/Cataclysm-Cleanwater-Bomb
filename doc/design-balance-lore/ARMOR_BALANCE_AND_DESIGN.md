...
> [!IMPORTANT] **Moved / 已迁移**
>
> Stable document ID / 稳定文档 ID: `json-armor-design`
> 中文: https://crimsoncrossbunker.github.io/CCB-Docs/json/armor-design/
> English: https://crimsoncrossbunker.github.io/CCB-Docs/en/json/armor-design/
...
- [Armor Balance And Design](#armor-balance-and-design)
  ...
  - [What is possible](#what-is-possible)
    - [Advanced Armor Definitions](#advanced-armor-definitions)
    ...
    - [Multi Material Inheritance](#multi-material-inheritance)
    ...
    - [Melee, Ranged and Vitals Coverage](#melee-ranged-and-vitals-coverage)
    ...
    - [Transform vs Durability](#transform-vs-durability)
      - [Explanation](#explanation-12)
      - [Example](#example-12)
      - [Further Reading](#further-reading-11)
    - [Actions and Transforms](#actions-and-transforms)
      - [Explanation](#explanation-13)
      - [Example](#example-13)
      - [Further Reading](#further-reading-12)
    - [Enchantments / Traits](#enchantments--traits)
      - [Explanation](#explanation-14)
      - [Example](#example-14)
      - [Further Reading](#further-reading-13)
    - [Notable Flags](#notable-flags)
      - [Layers](#layers-1)
      - [Clothing stuff](#clothing-stuff)
      - [Immunities/Defenses](#immunitiesdefenses)
      - [Mutation stuff](#mutation-stuff)
      - [Sci-fi](#sci-fi)
      - [Ablative](#ablative)
      - [Situational](#situational)
  - [Making your own items](#making-your-own-items)
    - [Balance/Considerations](#balanceconsiderations)
      - [The Golden Rule Of Balance](#the-golden-rule-of-balance)
      - [The Golden Rule Of Design](#the-golden-rule-of-design)
      - [Subjective Values](#subjective-values)
      - [Layer](#layer)
      - [Warmth](#warmth)
      - [Coverage](#coverage)
      - [Encumbrance](#encumbrance)
