...
> [!IMPORTANT] **Moved / 已迁移**
>
> Stable document ID / 稳定文档 ID: `design-steel-crafting`
> 中文: https://crimsoncrossbunker.github.io/CCB-Docs/design/steel-crafting/
> English: https://crimsoncrossbunker.github.io/CCB-Docs/en/design/steel-crafting/
...
Hardening only takes a medium or high carbon steel, and tanks of quenching liquid, and does not require any additional materials. It takes some practice to heat the steel to the right temperature and quench it at the right time. Differential hardening techniques for blades take more time than uniform hardening, but the process is similar. This usually does not take as long as case hardening, and is a rather straightforward process but for the sake of simplicity, and gamification, it should add a maximum of 3-5 hours to the crafting time of unhardened high steel items. 
