...
>
> Stable document ID / 稳定文档 ID: `archive-build-cygwin`
> 中文: https://crimsoncrossbunker.github.io/CCB-Docs/archive/build/cygwin/
> English: https://crimsoncrossbunker.github.io/CCB-Docs/en/archive/build/cygwin/
> Moved date / 迁移日期: `2026-08-02`
> Last in-repository commit / 仓库内最后适用 commit: `0378ca2b84303cf614c617c9d9eaa50138cd21ff`
> No current CCB CI/support evidence; Cygwin instructions are obsolete and superseded by maintained Windows paths.
